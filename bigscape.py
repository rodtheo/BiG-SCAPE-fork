...
def CMD_parser():
    ...
    parser.add_argument("--mibig", dest="mibig20", default=False, action="store_true",
                        help="Use included BGCs from the MIBiG database. Only \
                        relevant (i.e. those with distance < max(cutoffs) against\
                        the input set) will be used. Currently uses version 2.0 \
    ...
    parser.add_argument("--mibig14", dest="mibig14", default=False, action="store_true",
                        help="Include BGCs from the previous version of MIBiG (1.4)")
...
if __name__=="__main__":
    ...
    use_relevant_mibig = options.mibig13 or options.mibig14 or options.mibig20
    ...
    if use_relevant_mibig:
        if options.mibig13:
            ...
            mibig_zipfile_numbgcs = ("MIBiG_2.0_final.zip", "MIBiG_2.0_final", 1911)
